class Simulation{
	constructor(){
		...
		this.rigidBodys.push(new Rigidbody(new Rectangle(new Vector2(100,600), 200,100),10));
		this.rigidBodys.push(new Rigidbody(new Rectangle(new Vector2(600,400), 300,300),0));
		this.rigidBodys.push(new Rigidbody(new Circle(new Vector2(900,300),50.0),10));
