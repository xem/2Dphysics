class FixedJoint extends Joint{
    constructor(connection){
        ...
        this.relativeOrientation = this.rigiB.getShape().orientation - this.rigiA.getShape().orientation;
    ...
    updateConnectionA(){
        ...
        let currentOrientationDiff = this.rigiB.getShape().orientation - this.rigiA.getShape().orientation;
        let fixedOrientationVel = this.relativeOrientation - currentOrientationDiff;
        this.rigiB.angularVelocity += fixedOrientationVel * 0.5;
    ...
    updateConnectionB(){
        ...
        let currentOrientationDiff = this.rigiA.getShape().orientation - this.rigiB.getShape().orientation;
        let fixedOrientationVel = this.relativeOrientation - currentOrientationDiff;
        this.rigiA.angularVelocity += fixedOrientationVel * 0.5;
        this.restoreMaterial();
    }
