class Simulation{
	constructor(worldSize){
		...
		rect.createAnchor(new Vector2(-50,25));
		let anchorPoint = rect.createAnchor(new Vector2(50,25));
		rect.removeAnchor(anchorPoint);
		this.rigidBodies.push(new Rigidbody(rect,100));
