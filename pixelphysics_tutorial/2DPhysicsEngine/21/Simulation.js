class Simulation{
	constructor(worldSize){
		...
		this.rigidBodies.push(new Rigidbody(new Rectangle(new Vector2(300,300), 200,100),60));
		this.rigidBodies.push(new Rigidbody(new Rectangle(new Vector2(400,150), 200,100),20));
		this.rigidBodies.push(new Rigidbody(new Rectangle(new Vector2(200,0), 200,100),20));

		this.rigidBodies.push(new Rigidbody(new Circle(new Vector2(900,300),60.0),100));
	}
